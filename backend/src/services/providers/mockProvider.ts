...
const CATALOG = [
  {
    type: "Speeding",
    typeAr: "تجاوز السرعة المقررة",
    desc: "Exceeding the posted speed limit",
    descAr: "تجاوز الحد الأقصى للسرعة",
    amount: 600,
    points: 4,
  },
  {
    type: "Red Light",
    typeAr: "تجاوز الإشارة الحمراء",
    desc: "Crossing on a red traffic signal",
    descAr: "عبور الإشارة الضوئية الحمراء",
    amount: 6000,
    points: 7,
  },
  {
    type: "Illegal Parking",
    typeAr: "الوقوف في مكان ممنوع",
    desc: "Parking in a restricted zone",
    descAr: "الوقوف في منطقة محظورة",
    amount: 500,
    points: 0,
  },
  {
    type: "No Seatbelt",
    typeAr: "عدم ربط حزام الأمان",
    desc: "Driver not wearing a seatbelt",
    descAr: "عدم استخدام حزام الأمان أثناء القيادة",
    amount: 500,
    points: 0,
  },
  {
    type: "Mobile Phone Use",
    typeAr: "استخدام الهاتف أثناء القيادة",
    desc: "Using a phone while driving",
    descAr: "استخدام الهاتف المحمول أثناء القيادة",
    amount: 500,
    points: 0,
  },
  {
    type: "Expired Registration",
    typeAr: "انتهاء استمارة المركبة",
    desc: "Driving with expired vehicle registration",
    descAr: "قيادة مركبة منتهية الاستمارة",
    amount: 500,
    points: 0,
  },
];
