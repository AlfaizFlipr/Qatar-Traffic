        ...
        <SimpleGrid cols={{ base: 1, md: 2 }} spacing="lg" className={styles.grid}>
          <div className={styles.panel}>
            <Group gap={8}>
              ...
              <Text c="white" size="sm">{t.stats.panelService}</Text>
            </Group>
            <Text fw={800} size="2rem" mt="md">{t.stats.panelTitle}</Text>
            <Text c="white" opacity={0.9} mt="sm">{t.stats.panelDesc}</Text>
            ...
            {t.stats.items.map((item, index) => {
              ...
              return (
                <div className={styles.statBox} key={item.label}>
                  ...
                  <Text fw={800} size="2rem">{item.value}</Text>
